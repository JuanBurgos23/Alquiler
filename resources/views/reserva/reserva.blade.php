    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid py-4">
            <div class="col-12">
                ...
                <form action="{{route('reserva_register')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div role="main" class="form-all">
                        <div class="form-section page-section">
                            <li id="cid_1" class="form-input-wide" data-type="control_head">
                                <div class="form-header-group  header-large">
                                    <div class="header-text httac htvam">
                                        <h1 id="header_1" class="form-header" data-component="header">NOTA RESERVA</h1>
                                        <div id="subHeader_1" class="form-subHeader">REGISTRO DE INQUILINO</div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li id="cid_3" class="form-input-wide" data-type="control_head">
                                <div class="form-header-group  header-default">
                                    <div class="header-text httal htvam">
                                        <h2 id="header_3" class="form-header" data-component="header">Datos de la Reserva</h2>
                                    </div>
                                </div>
                            </li>
                            <li class="form-line" data-type="control_fullname" id="id_4" data-compound-hint=",,">
                                <div id="cid_4" class="form-input-wide" data-layout="full">
                                    <div data-wrapper-react="true" class="extended">
                                        <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
                                            <input type="date" id="fecha_inicio" name="fecha_inicio" class="form-textbox" data-defaultvalue="" autoComplete="section-input_4 given-name" size="10" data-component="first" aria-labelledby="label_4 sublabel_4_first" value="" />
                                            <label class="form-sub-label" for="first_4" id="sublabel_4_first" style="min-height:13px">Fecha Inicio</label>
                                        </span><span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
                                            <input type="date" id="fecha_fin" name="fecha_fin" class="form-textbox" data-defaultvalue="" autoComplete="section-input_4 given-name" size="10" data-component="first" aria-labelledby="label_4 sublabel_4_first" value="" />
                                            <label class="form-sub-label" for="first_4" id="sublabel_4_first" style="min-height:13px">Fecha Fin</label>
                                        </span><span class="form-sub-label-container" style="vertical-align:top" data-input-type="last">
                                            <input type="time" id="hora_reserva" name="hora_reserva" class="form-textbox" data-defaultvalue="" autoComplete="section-input_4 family-name" size="15" data-component="last" aria-labelledby="label_4 sublabel_4_last" value="" />
                                            <label class="form-sub-label" for="last_4" id="sublabel_4_last" style="min-height:13px">Hora de Reserva</label>
                                        </span><span class="form-sub-label-container" style="vertical-align:top" data-input-type="last">
                            ...
                            <li class="form-line" data-type="control_fullname" id="id_4" data-compound-hint=",,">
                                <div id="cid_4" class="form-input-wide" data-layout="full">
                                    <div data-wrapper-react="true" class="extended">
                                        ...
                                        <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
                                            <input type="texarea" id="descripcion" name="descripcion" class="form-textbox" data-defaultvalue="" autoComplete="section-input_4 given-name" size="10" data-component="first" aria-labelledby="label_4 sublabel_4_first" value="" />
                                            <label class="form-sub-label" for="first_4" id="sublabel_4_first" style="min-height:13px">Descripcion</label>
                                        </span><span class="form-sub-label-container" style="vertical-align:top" data-input-type="last">
                                            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
                                                <input type="int" id="monto" name="monto" class="form-textbox" data-defaultvalue="" autoComplete="section-input_4 given-name" size="10" data-component="first" aria-labelledby="label_4 sublabel_4_first" value="" />
                                                <label class="form-sub-label" for="first_4" id="sublabel_4_first" style="min-height:13px">Monto</label>
                                            </span><span class="form-sub-label-container" style="vertical-align:top" data-input-type="last">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="card mb-4">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-text">{{ $cuarto->dimension->ancho }} x {{ $cuarto->dimension->largo }}</p>
                                                            <p class="card-text">Precio: Bs {{ $cuarto->precio }}</p>
                                                            <p class="card-text" style="color: {{ $cuarto->estado === 'Disponible' ? 'green' : ($cuarto->estado === 'Reservado' ? 'red' : 'black') }}">
            ...
            <script>
                // Función para seleccionar un cuarto y agregarlo a la lista
