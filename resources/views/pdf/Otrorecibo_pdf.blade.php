    ...
    <div class="recibo">
        ...
        <div class="header">
            ...
            <div class="empresa-info">
                ...
                <p class="direccion">Barrio Urkupiña C/Santa Barbara</p>
                <p class="telefono">Teléfono: 76095949-78538094</p>
            </div>
        </div><br><br>
        <div class="content">
            <div>Recibí de: <span class="line">{{$recibos->recibi_de}}</span></div><br>
