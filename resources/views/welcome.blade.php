...
<body>
        ...
        <div class="container ">
            <div class="menu-bg-wrap ">
                <div class="site-navigation ">
                    <a href="#" class="logo m-0 float-start">Alquiler Burgos</a>
                            ...
                            <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                                ...
                                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                                   ...
                                   <li class="active"><a href="{{ route('login') }}" class="active">Iniciar Sesion</a></li> 
                                    ...
                                    <li class="active"><a href="{{ route('register') }}" class="active">Registrarse</a></li> 
                                    @endif
                                    @endauth
                                </div>
                                @endif
    ...
    <div class="hero">
        <div class="hero-slide">
            <div class="img overlay prueba" style="background-image: url('{{asset('cuartos/casa.jpg')}}')"></div>
            <div class="img overlay prueba" style="background-image: url('{{asset('cuartos/casa2.jpg')}}')"></div>
            <div class="img overlay prueba" style="background-image: url('{{asset('cuartos/tinglado.jpg')}}')"></div>
        </div>
    ...
    <div class="section section-5 bg-light">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0">
                    <div class="h-100 person">
                        <img src="{{asset('inicio/images/person_2-min.jpg')}}" alt="Image" class="img-fluid" />
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="widget">
                        <h3>Contact</h3>
                        <address>43 Barrio Urkupiña c/santa barbara</address>
