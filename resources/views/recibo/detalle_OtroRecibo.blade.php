                    ...
                    <div class="container">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><strong>Nombre:</strong> {{ $recibos->recibi_de}}</p>
                                



                                <a href="{{route('mostrar_Otrosrecibos')}}" class="btn btn-primary">Volver</a>
                                <a href="{{ route('Otrorecibo.pdf', ['id' => $recibos->id]) }}" target="_blank"
