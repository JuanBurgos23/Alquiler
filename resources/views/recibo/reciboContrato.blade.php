    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container">
            <div class="receipt">
                ...
                <hr>
                <form action="{{ route('resgistrar_recibo') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <input type="hidden" id="id_contrato" name="id_contrato" value="{{ $contrato->id }}"> <!-- Campo oculto para contrato_id -->
                            <p><strong>Fecha de Pago:</strong>
                                <input type="date" class="form-control" id="fecha_pago" name="fecha_pago" value="{{ $fecha ?? 'n/a' }}" readonly>
                            </p>
                            ...
                            <p><strong>Recibi de:</strong> {{ $contrato->inquilino->nombre_completo ?? 'n/a' }}</p>
                    ...
                    <hr>
                    <button type="submit" class="btn btn-primary btn-block no-print subirbtn">Guardar Recibo</button>
                </form>
            </div>
        </div>
